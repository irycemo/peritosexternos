...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('predios', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('superficie_terreno', 15,4)->nullable();
            $table->unsignedDecimal('superficie_construccion', 15,4)->nullable();
            $table->unsignedDecimal('superficie_judicial', 15,4)->nullable();
            $table->unsignedDecimal('superficie_notarial', 15,4)->nullable();
            ...
            $table->unsignedDecimal('valor_total_terreno', 15,4)->nullable();
            $table->unsignedDecimal('valor_total_construccion', 15,4)->nullable();
            $table->unsignedDecimal('valor_catastral', 15,4)->nullable();
