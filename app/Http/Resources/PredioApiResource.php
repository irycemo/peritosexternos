...
use App\Http\Resources\ColindanciasResource;
...
class PredioApiResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'colindancias' => ColindanciasResource::collection($this->colindancias),
            'propietarios' => PropietariosResource::collection($this->propietarios->sortBy('persona.nombre')),
