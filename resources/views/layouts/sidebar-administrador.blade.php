<div x-data="{openRoles:true, openDistritos:true}">
    ...
    @can('Lista de usuarios')
        ...
        <x-nav-dropdown>
            ...
            <x-slot name="body">
                ...
                <a  href="{{ route('e_firmas') }}" class="mb-3 capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex items-center hover  hover:bg-gray-100 p-2 px-4 rounded-xl focus:outline-rojo focus:outline-offset-2 w-full">
    ...
    @can('Avaluos')
        ...
        <a href="{{ url('avaluos_admin') }}" class="capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
    ...
    @can('Umas')
        ...
        <a href="{{ url('umas') }}" class="capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
    ...
    @can('Lista de valores unitarios')
        ...
        <a href="{{ url('valores_unitarios_construccion') }}" class="capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
    ...
    @can('Lista de valores unitarios')
        ...
        <a href="{{ url('valores_unitarios_rusticos') }}" class="capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-4">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            </svg>

            Valores Unit. Rusticos
        </a>

    @endcan

    <a href="{{ route('acuerdos_valores') }}" class="capitalize font-medium text-sm hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
