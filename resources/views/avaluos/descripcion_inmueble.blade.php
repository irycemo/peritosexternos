...
<p class="parrafo">
    ...
    <strong>Superficie de terreno total:</strong>  {{ $predio->superficie_terreno }}

    @if ($predio->superficie_construccion)

        <strong>Superficie de construcción total:</strong> {{ $predio->superficie_construccion }} Metros cuadrados
