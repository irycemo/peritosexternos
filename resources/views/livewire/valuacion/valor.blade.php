                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input readonly class="bg-white rounded text-xs w-full" type="text" value="{{ $predio->superficie_construccion  + collect($terrenosCondominio)->sum('superficie_proporcional') }}"></td>
                            </tr>
