<div class="mb-1">
    ...
    @if($predio)
        ...
        <div class="space-y-5 mb-5">
            ...
            @include('livewire.valuacion.comun.terrenos')

            @include('livewire.valuacion.comun.construcciones')

            @if($predio->edificio != 0)

                @include('livewire.valuacion.comun.terrenos-comun')

                @include('livewire.valuacion.comun.construcciones-comun')
                ...
                <div class="bg-gray-100 p-4 rounded-xl  overflow-auto">
                    ...
                    <table class=" w-full">
                        ...
                        <tbody  >
                            ...
                            <tr>
                                <td class="text-right text-xs lg:text-base whitespace-nowrap">Superficie de terreno</td>
                            ...
                            <tr>
                                <td class="text-right text-xs lg:text-base whitespace-nowrap">Superficie de construcción</td>
